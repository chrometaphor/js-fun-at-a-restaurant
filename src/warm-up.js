...
var vegetables = ["carrot", "tomato", "celery", "potato", "lettuce"];

// Write the code to access the 3rd element of the Array, using bracket
// notation.

var thirdVegetable = vegetables[2];
console.log(thirdVegetable)

// Create a new variable "fruits" and assign it to an Array of 7
// different fruits.

var fruits = ["apple", "banana", "cherry", "grape", "kiwi", "lemon", "mango"];
...
var groceryStore = {
    ...
    // Other key-value pairs that might make sense to add to this object could include:
    
    // address: the street address of the store
    // hours: an object or array representing the store's hours of operation
    // departments: an array of strings representing the different departments within the store
    // phoneNumber: a string representing the store's phone number
    // website: a URL string for the store's website
